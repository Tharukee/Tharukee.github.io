...
const Archive = () => {
  ...
  //       <h2 className="text-3xl font-titleFont font-semibold text-[#D2B48C]">
  //         UI/UX Designs
  //       </h2>
  //       <p className="text-sm font-titleFont text-[#D2B48C]">
  //         view the archive
  //       </p>
  //     </div>
  ...
  //           className="w-36 h-12 rounded-md text-[#D2B48C] text-[13px] border border-[#D2B48C] hover:bg-hoverColor duration-300"
  //         >
  //           Show Less
  //         </button>
  //       ) : (
